...
public class Erosion : MonoBehaviour
{
    ...
    internal int[][] erosionBrushIndices;
    internal float[][] erosionBrushWeights;
    internal System.Random prng;

    internal int currentSeed;
    internal int currentErosionRadius;
    internal int currentMapSize;
    ...
    internal HeightAndGradient CalculateHeightAndGradient(float[] nodes, int mapSize, float posX, float posY)
    {
        int coordX = (int)posX;
        int coordY = (int)posY;
    ...
    internal void InitializeBrushIndices(int mapSize, int radius)
    {
    ...
    internal struct HeightAndGradient
    {
        public float height;
